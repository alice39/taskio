...
future_fn(void, listener)(struct taskio_semaphore* sem) { return_future_fn(void, listener, sem); }

future_fn(void, shoot)(struct taskio_semaphore* sem) { return_future_fn(void, shoot, sem); }
