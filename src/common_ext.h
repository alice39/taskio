...
future_fn(size_t, taskio_join_ext)(struct taskio_allocator* allocator, size_t len, struct taskio_join_task* head,
                                   taskio_join_on_ready on_ready, taskio_join_on_finish on_finish,
